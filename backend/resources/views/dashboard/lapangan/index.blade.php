...
@section('content')
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <button class="bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded-lg text-sm shadow transition">
            + Tambah Laporan Baru
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            {{-- Tambahkan :sub-posko="$subPosko" di sini --}}
