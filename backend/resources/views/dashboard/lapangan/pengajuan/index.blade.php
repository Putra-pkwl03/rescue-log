...
<div class="w-full px-4 sm:px-6 lg:px-8 mx-auto space-y-6 pb-10">
    ...
    <div class="bg-gradient-to-r from-blue-900 to-indigo-800 rounded-xl p-6 text-white shadow-md">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <div class="inline-flex items-center px-6 py-3 rounded-full text-xs font-semibold bg-yellow-500/30 text-white-200 border border-yellow-400/30 mb-2">
                    <svg class="w-3.5 h-3.5 mr-1.5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20">
