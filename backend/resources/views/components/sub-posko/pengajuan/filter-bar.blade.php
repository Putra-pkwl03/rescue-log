<div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6 flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <form action="{{ route('komando.pengajuan.index') }}" method="GET" class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto flex-1">
        ...
        <div class="w-full sm:w-52">
            <select name="status" onchange="this.form.submit()" class="w-full h-10 px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none cursor-pointer bg-white">
    ...
    <button onclick="openModalCreate()" type="button" class="w-full md:w-auto shrink-0 h-10 inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 transition shadow-sm whitespace-nowrap">
