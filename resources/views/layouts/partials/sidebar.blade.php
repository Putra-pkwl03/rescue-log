<aside class="w-64 bg-gray-900 text-white flex flex-col md:flex">
    ...
    <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
        <!-- Menu Global (Bisa dilihat semua orang, opsional) -->
        ...
        @if(Auth::user()->role === 'admin')
            ...
            <a href="{{ route('admin.master') }}" class="block px-4 py-2 mt-2 text-sm font-semibold rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white">Data Master</a>
            <a href="{{ route('admin.pengguna') }}" class="block px-4 py-2 mt-2 text-sm font-semibold rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white">Manajemen Pengguna</a>
        ...
        @elseif(Auth::user()->role === 'komando')
            ...
            <a href="{{ route('dashboard.komando') }}" class="block px-4 py-2 text-sm font-semibold rounded-lg bg-blue-600 text-white">Dashboard Komando</a>
        ...
        @elseif(Auth::user()->role === 'lapangan')
            ...
            <a href="{{ route('dashboard.lapangan') }}" class="block px-4 py-2 text-sm font-semibold rounded-lg bg-blue-600 text-white">Dashboard Lapangan</a>
